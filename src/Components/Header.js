        ...
        <div className={classes.headerDiv}>
            ...
            <div className={classes.navigationDiv}>
                <ul className={classes.menulist}>
                    ...
                    <li onClick={serviceScrollHandler} className={classes.menu}><a href="">SERVICES</a></li>
                    <li onClick={productHandler} className={classes.menu}><a href="">PRODUCTS</a></li>
                    <li onClick={aboutScrollHandler} className={classes.menu}><a href="">ABOUT US</a></li>
                    <li onClick={contactScrollHandler} className={classes.menu}><a href="">CONTACT US</a></li>
                    <li onClick={termsScrollHandler} className={classes.menu}><a href="">T&C</a></li>
                </ul>
            </div>
        </div>
    )
